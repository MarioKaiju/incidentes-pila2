...
from .views import VistaComentarIncidente, VistaListaIncidentes, VistaDetalleIncidente, VistaCrearIncidente, VistaEditarIncidente, VistaEliminarIncidente
...
urlpatterns = [
  ...
  path('inc/<uuid:pk>/comentar/', VistaComentarIncidente.as_view(), name='comentar_incidente'),
